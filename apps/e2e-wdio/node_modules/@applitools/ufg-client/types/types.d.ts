...
import type { HashedEntry, HashedResource, KnownResource } from './resources/resource';
export type { ResourceHashedEntry } from './resources/resource';
...
export interface RenderSettings {
    ...
    /** UFG accessibility report options: axe.run() options + the SDK-filled upload URL. */
    accessibilityReportOptions?: {
        axeCoreOptions: unknown;
        uploadUrl: string;
    };
}
...
export interface RenderResult {
    ...
    /** Location of the uploaded accessibility (axe) report, if the UFG returned one. */
