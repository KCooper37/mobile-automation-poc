    ...
    async function startRenders({ renders, logger = mainLogger, }) {
        ...
        const rendersOptions = renders.map(({ target, settings }) => {
            ...
            const renderOptions = {
                ...
                // Duplicated below at the top level: the grid reads accessibilityReportOptions as a VG option
                // from job.options; the top-level copy is the intended contract for once the grid follows it.
                options: settings.accessibilityReportOptions
                    ? { ...settings.ufgOptions, accessibilityReportOptions: settings.accessibilityReportOptions }
                    : settings.ufgOptions,
                scriptHooks: settings.hooks,
                agentId: defaultAgentId,
                prefixRenderId: settings.prefixRenderId,
                webhook: settings.uploadUrl,
                accessibilityReportOptions: settings.accessibilityReportOptions,
