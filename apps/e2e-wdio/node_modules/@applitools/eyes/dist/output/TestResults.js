...
class TestResultsData {
    ...
    get hasAutoAcceptedInfraUpdateSteps() {
        return Boolean(this._result.hasAutoAcceptedInfraUpdateSteps);
    }
    getHasAutoAcceptedInfraUpdateSteps() {
        return this.hasAutoAcceptedInfraUpdateSteps;
    }
    get allMismatchesAreInfra() {
        return Boolean(this._result.allMismatchesAreInfra);
    }
    getAllMismatchesAreInfra() {
        return this.allMismatchesAreInfra;
    }
    isPassed() {
