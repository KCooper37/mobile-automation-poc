...
export type Configuration<TSpec extends Core.SpecType = Core.SpecType> = {
    ...
    testName?: string;
    figmaBaselines?: string | Record<string, string | string[]>;
    figmaOptions?: Core.FigmaOptions;
    useDom?: boolean;
...
export declare class ConfigurationData<TSpec extends Core.SpecType = Core.SpecType> implements Required<Configuration<TSpec>> {
    ...
    get figmaBaselines(): string | Record<string, string | string[]>;
    set figmaBaselines(figmaBaselines: string | Record<string, string | string[]>);
    getFigmaBaselines(): string | Record<string, string | string[]>;
    setFigmaBaselines(figmaBaselines: string | Record<string, string | string[]>): this;
    get figmaOptions(): Core.FigmaOptions;
    set figmaOptions(figmaOptions: Core.FigmaOptions);
    getFigmaOptions(): Core.FigmaOptions;
    setFigmaOptions(figmaOptions: Core.FigmaOptions): this;
    get useDom(): boolean;
