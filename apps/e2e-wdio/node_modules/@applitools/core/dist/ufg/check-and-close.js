...
const build_accessibility_report_options_1 = require("./build-accessibility-report-options");
        ...
        const promises = snapshots.map(async (snapshot, i) => {
            ...
            try {
                ...
                try {
                    ...
                    // Only request a report when the check configures an accessibility standard.
                    const accessibilityReportOptions = settings.accessibilitySettings
                        ? (0, build_accessibility_report_options_1.buildAccessibilityReportOptions)({ accessibilityOptions: eyes.test.account.accessibilityOptions })
                        : undefined;
                    ...
                    // Fall back to the minted upload URL when the render result carries no report location.
                    if (accessibilityReportOptions === null || accessibilityReportOptions === void 0 ? void 0 : accessibilityReportOptions.uploadUrl)
                        (_f = baseTarget.accessibilityReportLocation) !== null && _f !== void 0 ? _f : (baseTarget.accessibilityReportLocation = accessibilityReportOptions.uploadUrl);
                    if (signal === null || signal === void 0 ? void 0 : signal.aborted) {
                        ...
                        environmentLogger.warn(`Render on environment with id "${(_g = baseEyes.test.environment) === null || _g === void 0 ? void 0 : _g.environmentId}" was aborted during one of the previous steps`);
                        throw new abort_error_1.AbortError(`Render on environment with id "${(_h = baseEyes.test.environment) === null || _h === void 0 ? void 0 : _h.environmentId}" was aborted during one of the previous steps`);
                    }
                            ...
                            settings: {
                                ...
                                event: {
                                    ...
                                    test: {
                                        ...
                                        environmentId: (_j = baseEyes.test.environment) === null || _j === void 0 ? void 0 : _j.environmentId,
                                    },
                    ...
                    environmentLogger.error(`Render on environment with id "${(_k = baseEyes.test.environment) === null || _k === void 0 ? void 0 : _k.environmentId}" failed due to an error`, error);
