...
const sdk_log_streaming_1 = require("./sdk-log-streaming");
...
function makeGetAccountInfo({ requests, agentId: defaultAgentId, logger: mainLogger }) {
    return async function getAccountInfo({ settings, logger = mainLogger, }) {
        ...
        (0, sdk_log_streaming_1.decideSdkLogStreaming)(result); // decide-once: stream SDK logs to the blob if this account opted in
        return result;
    };
}
